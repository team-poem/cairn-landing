'use client';
// React Bits by David Haz. MIT + Commons Clause; see public/licenses/react-bits-LICENSE.md.
...
import type { Frame, SurfaceOptions } from 'vgpu';
type CanvasFormat = NonNullable<SurfaceOptions['format']>;
      ...
      try {
        ...
        const outputFormat = (
          navigator as Navigator & {
            gpu: { getPreferredCanvasFormat(): CanvasFormat };
          }
